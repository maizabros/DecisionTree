...
double chiC_clases(cuenta_datos_clases res){
...
void calculo_entropia_clases(datos * vect, double totalVivos, double entropias_clases[10][2]){
    ...
    entropias_clases[8][0] = chiC_clases(res);
    ...
    entropias_clases[9][0] = chiC_clases(res);
